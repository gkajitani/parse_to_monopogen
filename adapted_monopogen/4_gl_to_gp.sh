...
# Using beagle to generate genotype probability files from gl.vcf.gz files.

# Directory containing the .gl.vcf.gz files
input_dir="./"
...
process_file() {
	...
	local out="${input_file%.gl.vcf.gz}.gp"
...
for input_file in "$input_dir"/*.gl.vcf.gz; do
